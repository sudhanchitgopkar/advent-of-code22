...
public class day5_1 {
	...
	try {
		...
		Stack <Character> toMove = new Stack <Character> ();
		for (int i = 0; i < mvAmt; i++) toMove.push(crates.get(from-1).pollFirst());
		while (!toMove.isEmpty()) crates.get(to-1).offerFirst(toMove.pop());
